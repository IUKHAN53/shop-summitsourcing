...
@section('content')
    <main class="main">
        <section class="hero-3 position-relative align-items">
            <h2 class="mb-30 text-center text-white shadow">What are you looking for?</h2>
            <form class="form-subcriber d-flex mb-30 text-center" style="width: 100%;" method="get" action="{{route('dropshipping')}}">
                <input type="search" name="searchTerm" placeholder="Enter your search" tabindex="-1">
            </form>
        </section>
        <section class="bg-grey-1 section-padding pt-100 pb-80 mb-80">
            <div class="container">
                <h1 class="mb-80 text-center">Dropshipping items</h1>
                                        ...
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{route('product-detail',$product['offerId'])}}">
                                                    <img class="default-img" loading="lazy" src="{{$product['imageUrl']}}" alt=""/>
                                                    <img class="hover-img" loading="lazy" src="{{$product['imageUrl']}}" alt=""/>
                                                </a>
                                            </div>
