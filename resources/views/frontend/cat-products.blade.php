...
@section('content')
    <main class="main">
        <section class="bg-grey-1 section-padding pt-100 pb-80 mb-80">
            <div class="container">
                <h1 class="mb-80 text-center">Items in {{$category->name}}</h1>
                            ...
                            <div class="sort-by-product-area">
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a href="{{ request()->fullUrlWithQuery(['pageSize' => 10]) }}"
                                                   class="{{ $pageSize == 10 ? 'active' : '' }}">10</a></li>
                                        ...
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{route('product-detail',$product['offerId'])}}">
                                                    <img class="default-img" loading="lazy" src="{{$product['productImage']['images'][0]}}" alt=""/>
                                                    <img class="hover-img" loading="lazy" src="{{$product['productImage']['images'][0]}}" alt=""/>
                                                </a>
                                            </div>
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <div class="product-card-bottom">
                                                <div class="product-price">
                                                    <span>{{convertCurrency($product['productSaleInfo']['priceRangeList'][0]['price'])}}</span>
                                                </div>
                                                <div class="add-cart">
                                                    <a class="add" href="#"><i
